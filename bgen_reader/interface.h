...
void bgen_free_samples(const struct bgen_file *bgen, struct bgen_string *samples);
...
int bgen_max_nalleles(struct bgen_vi *index);

struct bgen_vg *bgen_open_variant_genotype(struct bgen_vi *index, size_t variant_idx);
